...
- **Master’s Thesis (Advanced Mathematics)**  
  *Stability Analysis and Neural Network Modelling of Clustered Large-Scale Brain Dynamics*
  ([PDF](msc-maths-thesis.pdf))([PDF](TFM_slides_def.pdf))([Master Project GitHub](https://github.com/FerranEstrella/TFM))
...
* *Stochastic Growth Modeling: Hubbert Curves, Bayesian Inference, and Applications* ([HTML](Stochastic-Growth-Exercises-1.html))([HTML](Stochastic-Growth-Exercises-2.html))([HTML](Stochastic-Growth-Exercises-3.html))([HTML](Stochastic-Growth-Exercises-4.html))
...
* *LSTM for Sentiment Analysis* ([PDF](LSTM.pdf)) ([Code](LSTMforSentimComplete.py))
